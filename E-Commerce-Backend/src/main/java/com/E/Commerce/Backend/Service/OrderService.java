...
import com.E.Commerce.Backend.Mapper.OrderMapper;
import com.E.Commerce.Backend.Model.*;
import com.E.Commerce.Backend.Repositories.OrderRepository;
...
public class OrderService
{
    ...
    public OrderDto createOrder(Long userId, String address, String phoneNumber){
        ...
        if(!user.isEmailConfirmation()){
            throw new IllegalStateException("Email not Confirmed. Please confirm the email before placing the order");
        }
